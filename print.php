    ...
    <div class="notice">
        <div class="header">
            ...
            <h3 data-fill="owner_name">Sam Watcher</h3>
            <h3 data-fill="owner_address">1 Watcher Rd, Yune MI</h3>
            <h3>(518) 929-5872</h3>
        </div>
        <p id="todays_date"><strong>Date:</strong> 05/08/2024</p>
        <br>
        <p><strong>To:</strong></p>
        <p data-fill="tenant_name">Luke Simmons</p>
        <p data-fill="tenant_address">54 Watcher Rd, Yune MI</p>
        <br>
        <p><strong>Landlord:</strong></p>
        <p data-fill="owner_name">Sam Watcher</p>
        <p data-fill="owner_address">1 Watcher Rd, Yune MI</p>
        <br>
        <p><strong>Re:</strong></string></p>
        <p data-append="tenant_address">Apartment: 54 Watcher Rd, Yune MI</p>
        <p data-fill="monthly_rent">Rents Due:$959</p>
        <p>month 1:$</p>
        <br>
        <p>Dear Tenant:</p>
        <br>
        ...
        <p class="right-align owners-name" data-fill="owner_name">Sam Watcher</p>
    </div>