...
function save_tenant_new_row(object $pdo, string $username, string $tenant_name, string $tenant_address, string $monthly_rent, string $rent_due_date, string $rental_owner, string $owner_address, string $owner_name, string $users_id) {
